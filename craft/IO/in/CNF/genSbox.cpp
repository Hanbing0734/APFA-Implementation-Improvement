 ...
 * @LastEditors: Hanbing
 * @LastEditTime: 2024-10-12 14:57:46
 * @FilePath: /SAT/CRAFT/IO/in/CNF/genSbox.cpp
 * @Description:
 *
...
// 设置控制台的编码为UTF-8（在Windows上）
    ...
    const std::array<std::bitset<ELEMENT_SIZE>, SBOX_SIZE> sbox = {0xc, 0xa, 0xd, 0x3, 0xe, 0xb, 0xf, 0x7, 0x8, 0x9, 0x1, 0x5, 0x0, 0x2, 0x4, 0x6};
