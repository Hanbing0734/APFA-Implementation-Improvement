 ...
 * @LastEditors: Hanbing
 * @LastEditTime: 2024-10-12 14:52:32
 * @FilePath: /SAT/CRAFT/src/util.cpp
 * @Description:
 *
...
void Util::init_RoundConstants() {
    RoundConstants[0][0] = 0b0001;  // a
    RoundConstants[0][1] = 0b0001;  // b
    for (int r = 0; r < ROUNDS - 1; r++) {
        // a
        RoundConstants[r + 1][0] = (RoundConstants[r][0] >> 1);
        RoundConstants[r + 1][0][3] = RoundConstants[r][0][1] ^ RoundConstants[r][0][0];
        // b
        RoundConstants[r + 1][1] = (RoundConstants[r][1] >> 1);
        RoundConstants[r + 1][1][2] = RoundConstants[r][1][1] ^ RoundConstants[r][1][0];
    }
}
...
int Util::genAnfFromSbox(int haveError, std::string &msg) {
...
int Util::genCnfFromSbox(int haveError, std::string &msg) {
    string funcName(__func__);
...
bitset<SBOX_ITEM_SIZE> Util::S(int index, int have_error) {
...
void Util::getSboxInErrorIndex(std::bitset<SBOX_ITEM_SIZE> &V) { V = this->sbox[sbox_error_index]; }
