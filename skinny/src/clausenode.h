 ...
 * @LastEditors: Hanbing
 * @LastEditTime: 2024-10-11 16:17:41
 * @FilePath: /SAT/skinny/include/clausenode.h
 * @Description: 将加密状态转换为cryptominisat需要的格式对应的编号
 *
 * Copyright (c) 2024 by Hanbing, All Rights Reserved.
 */

#ifndef _SKINNY_SRC_CLAUSENODE_H
#define _SKINNY_SRC_CLAUSENODE_H
...
#endif  // _SKINNY_SRC_CLAUSENODE_H